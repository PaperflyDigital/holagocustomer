...
const AddToCartSection = ({setqty, qty}) => {
  return (
    <div>
        <div className='mt-4 flex gap-2'>
            ...
            <button className=' py-1.5 rounded-md border border-[#cccccc] font-semibold px-10 hover:bg-black hover:text-white duration-300'>ADD TO CART</button>
